...
import com.spark.chiefwallet.util.DensityUtils;
    ...
    private void init(AttributeSet attrs) {
        ...
        if (typedArray != null) {
            try {
                ...
                mDotRadius = typedArray.getDimensionPixelSize(R.styleable.DepthMapView_dot_radius, DensityUtils.dp2px(getContext(), mDotRadius));
                mCircleRadius = typedArray.getDimensionPixelSize(R.styleable.DepthMapView_circle_radius, DensityUtils.dp2px(getContext(), mCircleRadius));
                mBackgroundColor = typedArray.getColor(R.styleable.DepthMapView_background_color, DensityUtils.getColor(getContext(), R.color.depth_background));
                mBuyLinePaint.setStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.DepthMapView_line_width, DensityUtils.dp2px(getContext(), 1.5f)));
                mSellLinePaint.setStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.DepthMapView_line_width, DensityUtils.dp2px(getContext(), 1.5f)));
                mTextPaint.setColor(typedArray.getColor(R.styleable.DepthMapView_text_color, DensityUtils.getColor(getContext(), R.color.depth_text_color)));
                mTextPaint.setTextSize(typedArray.getDimension(R.styleable.DepthMapView_text_size, DensityUtils.getDimension(getContext(), R.dimen.depth_text_size)));
                mBuyLinePaint.setColor(typedArray.getColor(R.styleable.DepthMapView_buy_line_color, DensityUtils.getColor(getContext(), R.color.depth_buy_line)));
                mSellLinePaint.setColor(typedArray.getColor(R.styleable.DepthMapView_sell_line_color, DensityUtils.getColor(getContext(), R.color.depth_sell_line)));
                mBuyPathPaint.setColor(typedArray.getColor(R.styleable.DepthMapView_buy_path_color, DensityUtils.getColor(getContext(), R.color.depth_buy_path)));
                mSellPathPaint.setColor(typedArray.getColor(R.styleable.DepthMapView_sell_path_color, DensityUtils.getColor(getContext(), R.color.depth_sell_path)));
                mSelectorBackgroundPaint.setColor(typedArray.getColor(R.styleable.DepthMapView_selector_background_color, DensityUtils.getColor(getContext(), R.color.depth_selector)));
            } finally {
                typedArray.recycle();
            }
        }
...
//                    mIsLongPress = true;
    ...
    private void drawSelectorView(Canvas canvas, int position) {
        ...
        if (position < mDrawWidth) {
            ...
            mRadioPaint.setColor(DensityUtils.getColor(getContext(), R.color.depth_buy_line));
        } else {
            canvas.drawCircle(position, y, mCircleRadius, mSellLinePaint);
            mRadioPaint.setColor(DensityUtils.getColor(getContext(), R.color.depth_sell_line));
        }
