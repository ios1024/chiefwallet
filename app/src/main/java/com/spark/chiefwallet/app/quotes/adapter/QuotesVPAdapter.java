 ...
 * ================================================
 */
public class QuotesVPAdapter extends BaseQuickAdapter<AllThumbResult.DataBean, QuotesVPAdapter.CoinPairPushBeanViewHolder> {
    public QuotesVPAdapter(@Nullable List<AllThumbResult.DataBean> data) {
