...
import com.spark.chiefwallet.databinding.ActivityLegalCurrentBinding;
 ...
 * ================================================
 */
@Route(path = ARouterPath.ACTIVITY_TRADE_LC)
public class LegalCurrencyActivity extends BaseActivity<ActivityLegalCurrentBinding, LegalCurrencyViewModel> {
    ...
    public int initContentView(Bundle savedInstanceState) {
        return R.layout.activity_legal_current;
    }
    ...
    private void initFragment() {
        ...
        mAdapter = new SlideTabPagerNoCacheAdapter(getSupportFragmentManager(),
                mFragments, mTitles);
        ...
        switch (view.getId()) {
            ...
            case R.id.legal_current_menu:
                new XPopup.Builder(this)
                        .atView(view)
                        .asCustom(new LegalCurrencyMenuPopup(this))
                        .show();
                break;
        }
    }
    ...
    private void showFilterPopup(View view) {
        if (mLegalCurrencyFilterPopup == null) {
            mLegalCurrencyFilterPopup = (LegalCurrencyFilterPopup) new XPopup.Builder(this)
                    .atView(view)
                    .asCustom(new LegalCurrencyFilterPopup(this, mTradeAreaListResult, new OnLcAdFilterListener() {
                        @Override
