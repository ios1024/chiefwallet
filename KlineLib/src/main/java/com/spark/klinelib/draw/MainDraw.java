package com.spark.klinelib.draw;
...
import com.spark.klinelib.KLineChartView;
import com.spark.klinelib.R;
import com.spark.klinelib.base.IChartDraw;
import com.spark.klinelib.base.IValueFormatter;
import com.spark.klinelib.entity.ICandle;
...
public class MainDraw implements IChartDraw<ICandle> {
    ...
    private void drawSelector(BaseKLineChartView view, Canvas canvas) {
        ...
        for (String s : strings) {
            mSelectorTextPaint.setColor(mContext.getResources().getColor(R.color.chart_text_bg));
